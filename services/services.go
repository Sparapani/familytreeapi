...
func GetRelativesByID(member graph.Member) (relativesOut []types.MembersResponse) {
	...
	for _, relative := range relatives {
		...
		relativeOut := types.MembersResponse{Name: relativeTemp.Name}
